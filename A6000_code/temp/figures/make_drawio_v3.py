# -*- coding: utf-8 -*-
"""draw.io v3: 3D-shadow boxes + real-data thumbnails + PROCESS diagrams
...
xml=f'''<mxfile host="app.diagrams.net" agent="SDA-Diff" version="24.0.0"><diagram id="sdadiff" name="SDA-Diff framework v3"><mxGraphModel dx="1800" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1720" pageHeight="730" math="0" shadow="0"><root><mxCell id="0"/><mxCell id="1" parent="0"/>{''.join(cells)}</root></mxGraphModel></diagram></mxfile>'''
open("temp/figures/fig1_sdadiff_v3.drawio","w").write(xml)
print(f"v3 生成：{len(cells)} 元素")
